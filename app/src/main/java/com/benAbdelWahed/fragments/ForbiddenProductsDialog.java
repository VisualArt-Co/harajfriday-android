...
public class ForbiddenProductsDialog extends DialogFragment {
    public ForbiddenProductsDialog() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        titleText.setText(R.string.forbiddenProducts);
        SettingsData data = (SettingsData) prefManager.getObject(SETTINGS, SettingsData.class);
        text.setText(data.getForbiddenProducts());
    }
