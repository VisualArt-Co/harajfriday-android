...
public class CommissionAccountDialog extends DialogFragment {
    public CommissionAccountDialog() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        titleText.setText(R.string.serviceUseTreaty);
        SettingsData data = (SettingsData) prefManager.getObject(SETTINGS, SettingsData.class);
        text.setText(data.getSiteCommissionAccount());
    }
